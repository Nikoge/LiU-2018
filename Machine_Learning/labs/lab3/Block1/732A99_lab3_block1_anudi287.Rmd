...
# loc_lat <- 55.3836 # The point to predict (up to the students)
# loc_long <- 12.8203
# date <- "2013-11-04"
# h1 <- 30
# h2 <- 0.01
...
result$additive_temp <- as.numeric(result$mult_temp)

p1 <- ggplot(data=result, aes(x=new_date_time, y = additive_temp)) + geom_point() + ggtitle("Predicted Temperature")
p2 <- ggplot(data=result, aes(x=new_date_time, y = mult_temp)) + geom_point() + ggtitle("Predicted Temperature")
