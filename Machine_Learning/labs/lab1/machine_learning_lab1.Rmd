...
plot(ridge_fit, xvar = "lambda", label = TRUE, main = "Plot showing shrinkage of coefficents with increase in log of lambda")


result <- NULL
for(i in 1:100){
temp <- coef(ridge_fit, i) %>% as.matrix()
...
plot(lasso_fit, xvar = "lambda", label = TRUE, main = "Plot showing shrinkage of coefficents with increase in log of lambda")
