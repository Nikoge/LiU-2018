...
ggroc(list(tree_0.05 = tree0.05, tree_0.10 = tree0.1))
ggroc(list(naive_0.05 = naive0.05, naive_0.10 = naive0.1))

ggroc(list(naive_0.05 = naive_list[[1]], naive_0.10 = naive_list[[2]]))





roc_obj <- roc(final$actual_test_class, final$match)
roc_df <- data.frame(
...
roc_df$model_type <- as.factor(roc_df$model_type)
roc_df$threshold <- as.factor(roc_df$threshold)
...
#ggroc(roc_obj) + ggtitle("ROC for thershold of 0.50")


roc_metric(probability_data_combined)
