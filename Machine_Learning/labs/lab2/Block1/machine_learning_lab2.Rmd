...
for(threshold in seq(from = 0.05, to = 0.95, by = 0.05)){
  ...
  temp <- final[final$threshold == threshold,]  
  temp_tree <- temp[temp$model == "tree",]
  temp_non_tree <- temp[temp$model != "tree",]

    tree_list[[paste0("tree", threshold)]] <- roc(temp_tree$actual_test_class, temp_tree$match)
    naive_list[[paste0("naive", threshold)]] <- roc(temp_non_tree$actual_test_class, temp_non_tree$match)

}

#printing ROC curves for different threshold

ggroc(list(naive_0.05 = naive_list[[1]], 
           naive_0.10 = naive_list[[2]],
           naive_0.15 = naive_list[[3]], 
           naive_0.20 = naive_list[[4]],
           naive_0.25 = naive_list[[5]], 
           naive_0.30 = naive_list[[6]],
           naive_0.35 = naive_list[[7]], 
           naive_0.40 = naive_list[[8]], 
           naive_0.45 = naive_list[[9]],
           naive_0.50 = naive_list[[10]], 
           naive_0.55 = naive_list[[11]],
           naive_0.60 = naive_list[[12]], 
           naive_0.65 = naive_list[[13]],
           naive_0.70 = naive_list[[14]], 
           naive_0.75 = naive_list[[15]],
           naive_0.80 = naive_list[[16]], 
           naive_0.85 = naive_list[[17]],
           naive_0.90 = naive_list[[18]], 
           naive_0.95 = naive_list[[19]])) + ggtitle("ROC of Naive Bayes Model vs. Threshold")

ggroc(list(tree_0.05 = tree_list[[1]], 
           tree_0.10 = tree_list[[2]],
           tree_0.15 = tree_list[[3]], 
           tree_0.20 = tree_list[[4]],
           tree_0.25 = tree_list[[5]], 
           tree_0.30 = tree_list[[6]],
           tree_0.35 = tree_list[[7]], 
           tree_0.40 = tree_list[[8]], 
           tree_0.45 = tree_list[[9]],
           tree_0.50 = tree_list[[10]], 
           tree_0.55 = tree_list[[11]],
           tree_0.60 = tree_list[[12]], 
           tree_0.65 = tree_list[[13]],
           tree_0.70 = tree_list[[14]], 
           tree_0.75 = tree_list[[15]],
           tree_0.80 = tree_list[[16]], 
           tree_0.85 = tree_list[[17]],
           tree_0.90 = tree_list[[18]], 
           tree_0.95 = tree_list[[19]])) + ggtitle("ROC of Tree Model vs. Threshold")

```
Analysis: We find that tree model is in general better than naive bayes model in terms of variation showed by the ROC curve. threshold of 0.45-0.6 yields highest ROC value for tree while 0.1,0.25 yields the best ROC curve for naive bayes model
