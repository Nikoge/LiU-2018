...
knitr::kable(contribution[,1:10], caption = "Contribution of PCA axis towards varience")
...
From the plot of PCA component vs. Viscoity, we can see that second component of PCA is needed, this is due to the fact the most of the data is vertically spread, removing this dimension would make it impossible to differenitate the types of diesel.
