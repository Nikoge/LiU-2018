...
#trace plots
plot(W_prime, main = "Trace plot of W` Matrix")

#plots
plot(ICA_extraction$X, main = "Pre-processed data")
plot(ICA_extraction$X%*%ICA_extraction$K, main = "PCA components")
plot(ICA_extraction$S, main = "ICA components") 
